...
<script>
  ...
  function connectSupabase() {
    if (!letstartApiUrl || !letstartProjectId) { showError('Cannot connect: missing API configuration.'); return; }
    const popup = window.open(\`\${letstartApiUrl}/api/v1/integrations/supabase/connect/\${letstartProjectId}\`, 'supabase-oauth', 'width=600,height=700,left=200,top=100');
